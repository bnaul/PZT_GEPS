...
def get_run_id(layer_type, size, num_layers, embedding, lr, drop_frac, batch_size, kernel_size, **kwargs):
    run = (f"{layer_type}{size:03d}_x{num_layers}_emb{embedding:03d}_{lr:1.0e}"
